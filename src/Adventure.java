...
public class Adventure {
    ...
    public void run() {
        ...
        gameMap.room5.setDescription("You did it " + getPlayerName() + ".. when no one believed in you" +
        ...
        gameMap.room9.setDescription("ey " + getPlayerName() + ", you are probably lost, like so many of us... " +
                "better get moving.");
